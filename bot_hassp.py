...
db = Database()
bot_settings = db.execute('SELECT * FROM administration_bot WHERE name="@Gsg_hassp_bot"')
...
ASSISTANT_ID = db.execute('SELECT assistant_token FROM administration_bot WHERE name="@Gsg_hassp_bot"')[0][0]
